                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <!-- start id-form -->
                                            <form action="AdminChangePassServlet" method="post">
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    <tr>
                                                        <th valign="top">Old Password:</th>
                                                        <td><input name="oldPassword" type="password" class="inp-form" id="oldpass" pattern="^[a-zA-Z0-9][\w\s]{5,50}$" oninvalid="InvalidOldPass(this);" oninput="InvalidOldPass(this);" required="true"/></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">New Password:</th>
                                                        <td><input name="newPassword" type="password" class="inp-form" id="newpass" pattern="^[a-zA-Z0-9][\w\s]{5,50}$" oninvalid="InvalidNewPass(this);" oninput="InvalidNewPass(this);" required="true" /></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Confirm Password:</th>
                                                        <td><input name="confirmPassword" type="password" class="inp-form" id="confirmpass" pattern=".{5,50}" oninvalid="InvalidConfirmPass(this);" oninput="InvalidConfirmPass(this);" required="true" /></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th>&nbsp;</th>
