...
<%@page import="nicky.entitybean.TblFeedback"%>
            ...
            <div id="page-top">
                ...
                <div id="top-search">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <form action="AdminFbShowServlet" method="post">
                            <tr class="alternate-row">
                                <td><input type="text"  name="txtSearch" value="Search By Username" onblur="if (this.value=='') { this.value='Search By Username'; }" onfocus="if (this.value=='Search By Username') { this.value=''; }" class="top-search-inp" /></td>
                                <td>
            ...
            <div class="nav-outer">
                ...
                <div class="nav">
                    <div class="table">
                        ...
                        <ul class="current"><li><a href="AdminFeedbackShow.jsp"><b>Feedback</b></a></li></ul>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    <%            if (request.getAttribute("INFO") == null) {
                                                    request.getRequestDispatcher("AdminFbShowServlet?action=Search&txtSearch=").forward(request, response);
                                                } else {
                                                    TblFeedback[] fbList = (TblFeedback[]) request.getAttribute("INFO");
                                    ...
                                    <form id="mainform" action="">
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                            <tr class="alternate-row">
                                                ...
                                                <th class="table-header-repeat line-left"><a href="">Sender</a></th>
                                                <th class="table-header-repeat line-left minwidth-1"><a href="">Question</a></th>
                                                <th class="table-header-repeat line-left minwidth-1"><a href="">Answer</a></th>
                                            ...
                                            <tr class="alternate-row">
                                                <td><%=i + 1%></td>
                                                <td><%=fbList[i].getFbID()%></td>
                                                <td><%=fbList[i].getFbDate()%></td>
                                                <td><%=fbList[i].getFbFrom()%></td>                                                
                                                <%if (fbList[i].getFbQuestion() != null) {%>
                                                <%if (fbList[i].getFbQuestion().length() > 50) {%>
                                                <td><%=fbList[i].getFbQuestion().substring(0, 50)%> </td>
                                                <% } else {%>
                                                <td><%=fbList[i].getFbQuestion()%></td>
                                                <% }%>
                                                <%} else {%>
                                                <td></td>
                                                <%}%>
                                                <%if (fbList[i].getFbAns() != null) {%>
                                                <%if (fbList[i].getFbAns().length() > 50) {%>
                                                <td><%=fbList[i].getFbAns().substring(0, 50) + "..."%> </td>
                                                <% } else {%>
                                                <td><%=fbList[i].getFbAns()%> </td>
                                                <% }%>
                                                <%} else {%>
                                                <td></td>
                                                <%}%>
                                                <td class="options-width">
                                                    <a href="AdminFbShowServlet?action=Edit&id=<%=fbList[i].getFbID()%>" class="icon-1 info-tooltip" title="Edit" ></a>
                                                    <a href="AdminFbShowServlet?action=Delete&id=<%=fbList[i].getFbID()%>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure to delete this record');" ></a>
                                                </td>
                                            </tr>
                                            <%}%>
