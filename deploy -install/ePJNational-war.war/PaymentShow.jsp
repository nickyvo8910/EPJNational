            ...
            <div id="contentBk" class="clearfix">
                <div id="content">
                    <div class="topImg clearfix">
                        ...
                        <p>Payment <strong>Show</strong></p>
                    </div>
                    <div class="wrapper">
                        <div class="column c-67 clearfix">
                            <div class="box">
                                ...
                                <div>
                                    <form action="PaymentShowServlet" method="post">
                                        <input type="hidden" name="eventID" value="<%=event.getEventID()%>"/>
                                        <input type="hidden" name="username" value="<%=user.getUsername()%>"/>
                                        <input id="CancelBT" class="cancel" type="button" onclick="doLink()" value="Cancel" />
                                        <input id="EnrollBT" class="submit" type="submit" value="Accept Payment" name="action"/>
                                    </form>
                                </div><%}%>
                            </div>
                        </div>
