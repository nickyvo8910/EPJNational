...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
                    ...
                    if (request.getAttribute("INFO") == null || request.getAttribute("INFO2") == null || request.getAttribute("date") == null) {
                        request.getRequestDispatcher("AdminReportLeastEvents.jsp").forward(request, response);
                    }
                    TblUsers[] users = (TblUsers[]) request.getAttribute("INFO");
    ...
    <body>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading-Name"><h1>Report Name: TOP ACTIVE USER</h1></div>
                <div id="page-bottom-date1"><h1 class="DateStig">Report Period : <%=date%></h1>
                                    ...
                                    <form id="mainform" action="">
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                            <tr class="alternate-row">
                                                ...
                                                <th class="table-header-repeat line-left"><a href="">Total Event Enrolled</a></th>
