    ...
    <body>
        ...
        <div id="page-top-outer">
            ...
            <div id="page-top">
                ...
                <!--  start top-search -->
                <div id="top-search">
                    <form action="AdminUserShowServlet" method="post">
                    ...
                    <div class="table">
                        ...
                        <ul class="current"><li><a href="AdminUserShow.jsp"><b>User</b><!--[if IE 7]><!--></a><!--<![endif]-->
                                ...
                                <div class="select_sub show">
                                    <ul class="sub">
                                        <li class="sub_show"><a href="AdminUserShow.jsp">View all users</a></li>
                                ...
                                <div id="table-content">
                                    <%
                                                if (request.getAttribute("INFO") == null) {
                                                    request.getRequestDispatcher("AdminUserShowServlet?action=Search&txtSearch=").forward(request, response);
                                                } else {

                                                    TblUsers[] userList = (TblUsers[]) request.getAttribute("INFO");
                                    %>
                                    <%int b = userList.length;%>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            var a = <%=b%>;
                                            $('#green').smartpaginator({ totalrecords: a, recordsperpage: 5, length: 2,
                                    ...
                                    <form id="mainform" action="">
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                            <tr>
                                                ...
                                                <th class="table-header-repeat line-left minwidth-1"><a href="">Birth</a></th>
                                            ...
                                            <tr class="alternate-row">
                                                <td><%=j + 1%></td>
                                                <%if (userList[i].getUsername().equals("Admin@mail.com") || userList[i].getUsername().equals("Default event") || userList[i].getUsername().equals("guest@yahoo.com")) {
                                                         i++;
                                                     }%>
                                                <td><%=userList[i].getUsername()%></td>
                                                <td><%=userList[i].getUserType()%></td>
                                                <td><%=userList[i].getFullname()%></td>
                                                <td><%=userList[i].getDob()%></td>
                                                <td><%=userList[i].getUserImg()%></td>
                                                <td class="options-width">
                                                    <a href="AdminUserShowServlet?action=Delete&id=<%=userList[i].getUsername()%>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure to delete this record');" ></a>
                                                </td>
                                            </tr>
                                            <%
                                                                          j++;                      }
