                    ...
                    <div id="socialButtons">
                        <%
                                    ...
                                    if (request.getAttribute("FB") == null) {
                                        request.getRequestDispatcher("FeedbackServlet?action=get").forward(request, response);
                                    }
                                    TblFeedback[] FB = (TblFeedback[]) request.getAttribute("FB");
                        %>
                    </div>
                </div>
                <div>
                ...
                <div class="wrapper">
                    ...
                    <div class="column c-67 clearfix">
                        ...
                        <div  id="product-table"   class="box contactUs">
                            <h4><span>Your Feedbacks</span></h4>
                                ...
                                <li class="clearfix">
                                    ...
                                    <div class="first">
                                        <div class="box boxInfo">
                                            <h6><%=FB[i].getFbFrom()%><span> says </span><%=FB[i].getFbDate()%></h6>

                                            <%
                                                 String QUES = FB[i].getFbQuestion();
                                                 String QUESProcess = "";
                        ...
                        <div class="column clearfix">
                            <div class="box contactUs ">
                                <h4><span>Feedback Form</span></h4>
                                <div class="boxInfo contactForm">
                                    <form id="contact" action="FeedbackServlet" method="post">

                                        <div>
                                            <label>Your Feedback</label>

                                            <textarea class="changepass" id="message" pattern="^[a-zA-Z[\w\s]+$]" required="true" oninvalid="InvalidFeedback(this);" oninput="InvalidFeedback(this);" placeholder="Message" name="txtFB"></textarea>
