    ...
    <body>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Edit FAQ</h1></div>

                <%  TblFAQ result = (TblFAQ) request.getAttribute("INFO");%>
                                    ...
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <div id="step-holder">
                                                ...
                                                <div class="step-dark-left"><a href="">Edit FAQ details</a></div>
                                            ...
                                            <!-- start id-form -->
                                            <form action="AdminFAQUpdateServlet" method="post">
                                                <!-- start id-form -->
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    
                                                    <tr>
                                                        <th valign="top">Question:</th>
                                                        <td><textarea name="txtQuestion" rows="" cols="" pattern=".{0,}" required="true" oninvalid="InvalidFAQQuestion(this);" oninput="InvalidFAQQuestion(this);" class="form-textarea"><%=result.getFaqQuestion() %></textarea></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Answer:</th>
                                                        <td><textarea name="txtAnswer" rows="" cols="" pattern=".{0,}" required="true" oninvalid="InvalidFAQAnswer(this);" oninput="InvalidFAQAnswer(this);" class="form-textarea"><%=result.getFaqAns() %></textarea></td>
                                                        <td></td>
                                                    </tr>
                                                    <input type="hidden" name="txtId" value="<%=result.getFaqID() %>" />
                                                    <tr>
                                                        <th>&nbsp;</th>
                                                        <td valign="top">
                                                            <input name="action" type="submit" value="Submit" class="form-submit" />
                                                            <a href="AdminFAQsShowServlet?action=Search"><input type="button" value="" class="form-reset"  /></a>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                </table>
