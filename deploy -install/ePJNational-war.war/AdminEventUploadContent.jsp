    ...
    <body>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Content Upload</h1></div>
                                    ...
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <div id="step-holder">
                                                ...
                                                <div class="step-dark-left"><a href="">Upload Event Content</a></div>
                                                <div class="step-dark-right">&nbsp;</div>
                                                <div class="clear"></div>
                                            </div>
                                            <!--  end step-holder -->
                                            <form action="upload_3.jsp" method="post" enctype="multipart/form-data">
                                                <!-- start id-form -->
                                                <%
                                                String id = request.getParameter("id");
                                                session.setAttribute("ADMINUPLOADEVENT", id);
                                                %>
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    <tr>
                                                        <th valign="top">Content :</th>
                                                        <td><input type="file" name="filebox" required="true" value="" class="inp-form" /></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th>&nbsp;</th>
