...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
                    ...
                    TblEvents result = (TblEvents) request.getAttribute("INFO1");
             //       boolean hadUser = (Boolean)request.getAttribute("hadUser");
                    
                    String date = result.getEventDate().toString();
                                    ...
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <div id="step-holder">
                                                ...
                                                <div class="step-dark-left"><a href="">Edit event details</a></div>
                                                <div class="step-dark-right">&nbsp;</div>
                                                <div class="clear"></div>
                                            </div>
                                            <!--  end step-holder -->
                                            <form action="AdminEventUpdateServlet" method="post">
                                                <!-- start id-form -->

                                                <input type="hidden" name="txtID" value ="<%=result.getEventID()%>" />
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    <tr>
                                                        <th valign="top">Event name:</th>
                                                        <td><input type="text" name="txtName" value="<%=result.getEventName()%>" class="inp-form" pattern="^[a-zA-Z][\w\s]{0,50}$" oninvalid="InvalidEventName(this);" oninput="InvalidEventName(this);" required="true" /></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Event Host:</th>
                                                        <td><input type="text" name="txtHost" value="<%=result.getEventHost()%>" class="inp-form" pattern="^[a-zA-Z][\w\s]{0,50}$" oninvalid="InvalidEventHost(this);" oninput="InvalidEventHost(this);" required="true" /></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Min participants:</th>
                                                        <td><input type="number" name="txtMin" readonly="true" value="<%=result.getEventMin()%>" class="inp-form" pattern="^[1-9]\d{1,}$" id="min" oninvalid="InvalidMinPart(this);" oninput="InvalidMinPart(this);" required="true" /></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Max participants:</th>
                                                        <td><input type="number" name="txtMax" readonly="true" value="<%=result.getEventMax()%>" class="inp-form" pattern="^[1-9]\d{1,}$" id="max" oninvalid="InvalidMaxPart(this);" oninput="InvalidMaxPart(this);" required="true" /></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Price:</th>
                                                        <td><input type="text" <%//if(hadUser==false){ %> readonly="true"<% //} %> name="txtPrice" value="<%=result.getEventPrice()%>" class="inp-form" pattern="^\d{1,}?.\d{0,2}$" placeholder="Ex : 5.55" oninvalid="InvalidPrice(this);" oninput="InvalidPrice(this);" required="true" /></td>
                                                    ...
                                                    <tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="date-pick" name="txtDay" value="<%=date%>"  class="inp-form"  readonly="true" /></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><textarea rows="" cols="" name="txtDes" class="form-textarea" pattern=".{0,}" type ="text" oninvalid="InvalidEventDes(this);" oninput="InvalidEventDes(this);" required="true"><%=result.getEventDes()%></textarea></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Image:</th>
                                                        <td><input type="file" name="txtImg" value="" class="inp-form" /></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th></th>
                                                        <td><img src="images/event/<%=result.getEventImg()%>" class="EventShowImages" alt="" /></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th>&nbsp;</th>
