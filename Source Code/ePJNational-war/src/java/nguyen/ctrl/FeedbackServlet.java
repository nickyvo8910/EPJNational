    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("get")) {
                ...
                TblFeedback[] FB = local.getFBListUserOK(username);
                request.setAttribute("FB", FB);
                url = "Feedback.jsp";
            }
            if (action.equals("Submit")) {
                String username = (String) session.getAttribute("username");
                String fb = request.getParameter("txtFB");
                int insert =local.insertFeedback(username, fb);
                if(insert == 1){
                    url = "Feedback.jsp";
                }else{
                ...
                request.setAttribute("ERROR", "Action is not suppported");
            }
