 ...
 * @author Quy
 */
public class AdminFeedbackUpdateServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String url = "AdminFeedbackShow.jsp";
            if (action.equals("Submit")) {
                 int fbID = Integer.parseInt(request.getParameter("txtId"));
                String fbAns = request.getParameter("txtAns");

                if (local.updateFB(fbID, fbAns) == 1) {
                    request.setAttribute("alert", "Update Successful");
                    url= "AdminFeedbackShow.jsp";
                }else{
                    request.setAttribute("alert", "Update Unsuccessful");
                    url = "AdminFeedbackUpdate.jsp";
                }
