 ...
 * @author QUYDNGC60257
 */
public class AdminReportPopularEventsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("Submit")) {
                ...
                PopEvent[] pop = local.reportTopEventFromTo(date, date1);
                int b = pop.length;
                if (b > 10) {
                    b = 10;
                }
                ...
                request.getRequestDispatcher("AdminTopPopularEvents.jsp").forward(request, response);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
