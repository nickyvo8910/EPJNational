...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
                    ...
                    if (request.getAttribute("INFOFAQ") == null) {
                        request.getRequestDispatcher("AdminFAQsShowServlet?action=Search").forward(request, response);
                    }
                    TblFAQ[] faqList = (TblFAQ[]) request.getAttribute("INFOFAQ");
            ...
            <div class="nav-outer">
                ...
                <div class="nav">
                    <div class="table">
                        ...
                        <ul class="current"><li><a href="AdminFAQShow.jsp"><b>FAQ</b></a>
                                <!--[if lte IE 6]><table><tr class="alternate-row"><td><![endif]-->
                                <div class="select_sub show">
                                    <ul class="sub">
                                        <li class="sub_show"><a href="AdminFAQShow.jsp">View all FAQ</a></li>
                        ...
                        <td>
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    <!--  start product-table ..................................................................................... -->
                                    <form id="mainform"action="AdminFAQsShowServlet" method="post">
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                            ...
                                            <tr class="alternate-row">
                                                ...
                                                <td><%=i+1%></td>
                                                <td><%=faqList[i].getFaqID() %></td>
                                                 <%
                                                 if(faqList[i].getFaqQuestion().length()>50 ){
                                               %> <td><%=faqList[i].getFaqQuestion().subSequence(0,50) +"..." %></td><% } else {
                                                      %> <td><%=faqList[i].getFaqQuestion()%></td><% } %>
                                                <%
                                                 if(faqList[i].getFaqAns().length()>50 ){
                                               %> <td><%=faqList[i].getFaqAns().subSequence(0,50) +"..." %></td><% } else {
                                                      %> <td><%=faqList[i].getFaqAns()%></td><% } %>
                                                <td class="options-width">
                                                    <a href="AdminFAQsShowServlet?action=Edit&FAQid=<%=faqList[i].getFaqID() %>" title="Edit" class="icon-1 info-tooltip"></a>
                                                    <a href="AdminFAQsShowServlet?action=Delete&FAQid=<%=faqList[i].getFaqID() %>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure to delete this record');"></a>
                                                </td>
                                            </tr>
                                            <%}%>
