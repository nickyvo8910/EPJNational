                            ...
                            if (item.isFormField()) {
                                ...
                                try {
                                    ...
                                    if (session.getAttribute("username") == null) {
                                        ...
                                        request.setAttribute("UPLOADIMG", fileName);
                                        request.getRequestDispatcher("UserProfileServlet?action=upload").forward(request, response);
                                    }
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
