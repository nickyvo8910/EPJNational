    ...
    <body>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading-report"><h1>Report Least Event</h1></div>

                <form action="AdminReportLeastEventsServlet" method="post">
                            ...
                            <td class="noheight">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr  valign="top">
                                        ...
                                        <td><a href=""  id="date-pick1"><img src="CSS-Image-JQuery/Admin/images/forms/icon_calendar.jpg"   alt="" /></a></td>
                                    </tr>
                                </table>
