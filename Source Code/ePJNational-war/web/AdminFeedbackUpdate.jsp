    ...
    <body>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Edit Feedback</h1></div>
                                        ...
                                        <tr valign="top">
                                            <td>
                                                ...
                                                <div id="step-holder">
                                                    ...
                                                    <div class="step-dark-left"><a href="">Feedback details</a></div>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    <%  TblFeedback result = (TblFeedback) request.getAttribute("INFO");%>
                                                    <form action="AdminFeedbackUpdateServlet" method="post">
                                                        <input type="hidden" name="txtId" value="<%=result.getFbID() %>" />
                                                        <tr>
                                                            <th valign="top">From User:</th>
                                                            <td><input type="text"  class="inp-form" value="<%=result.getFbFrom()%>" readonly /></td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                            <th valign="top">Question:</th>
                                                            <td><textarea rows="" cols="" class="form-textarea"  readonly  > <%=result.getFbQuestion()%> </textarea></td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                            <th valign="top">Answer:</th>
                                                            <td><textarea rows="" cols="" name ="txtAns" class="form-textarea" pattern=".{0,}" oninvalid="InvalidFeedbackAnswer(this);" oninput="InvalidFeedbackAnswer(this);" required="true"><%=result.getFbAns()%></textarea></td>
                                                            <td></td>
                                                        </tr>


                                                        <tr>
                                                            <th valign="top">Feedback date:</th>
                                                            <td class="noheight"> <%=result.getFbDate()%></td>
                                                            <td></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                ...
                                                                <a href="AdminFbShowServlet?action=Search&txtSearch=">  <input type="button" value="" class="form-reset"  /></a>
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                    </form>
