    ...
    <body>
                        ...
                        <ul class="current"><li><a href="AdminFAQShow.jsp"><b>FAQ</b></a>
                                ...
                                <div class="select_sub show">
                                    <ul class="sub">
                                        ...
                                        <li class="sub_show"><a href="AdminFAQInsert.jsp">Add FAQ</a></li>
                                    </ul>
                                </div>
                                <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                            </li>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Add FAQ</h1></div>
                                    ...
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <div id="step-holder">
                                                ...
                                                <div class="step-dark-left"><a href="">Add FAQ details</a></div>
                                                <div class="step-dark-right">&nbsp;</div>
                                                <div class="clear"></div>
                                            </div>
                                            <!--  end step-holder -->
                                            <form action="AdminFAQInsertServlet" method="post">
                                                <!-- start id-form -->
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">

                                                    <tr>
                                                        <th valign="top">Question:</th>
                                                        <td><textarea name="txtQuestion"  rows="" cols="" pattern=".{0,}" required="true" oninvalid="InvalidFAQQuestion(this);" oninput="InvalidFAQQuestion(this);" class="form-textarea"></textarea></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Answer:</th>
                                                        <td><textarea name="txtAnswer" rows="" cols="" pattern=".{0,}" required="true" oninvalid="InvalidFAQAnswer(this);" oninput="InvalidFAQAnswer(this);" class="form-textarea"></textarea></td>
                                                        <td></td>
                                                    </tr>
