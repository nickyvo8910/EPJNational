    ...
    <body>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Edit Content</h1></div>
                                    ...
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <div id="step-holder">
                                                ...
                                                <div class="step-dark-left"><a href="">Edit content details</a></div>
                                            ...
                                            <!-- start id-form -->
                                            <form action="AdminEventContentUpdateServlet" method="post">
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    <%
                                                                TblContents result = (TblContents) request.getAttribute("INFO");
                                                                int isSelected = result.getIsSelected();
                                                    %>

                                                    <tr>
                                                        <th valign="top">Username:</th>
                                                        <td>
                                                            <input type="text"  class="inp-form" value="<%=result.getSender()%>" readonly="true" /></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Event ID:</th>
                                                        <td><input type="text" value="<%=result.getTblEvents().getEventID()%>" class="inp-form" readonly="true" /></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Content URL:</th>
                                                        <td><input type="url" class="inp-form" value="<%=result.getContentURL()%>" readonly="true"/></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="top">Is Selected:</th>
                                                        <td>
                                                            <input name="ChkIsSelect" type="checkbox" <%if (isSelected == 1) {%> checked=<%}%>  class="checkbox-size" />
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                    <input type="hidden" name="textID" value="<%=result.getContentID()%>" />
                                                    <tr>
                                                        <th>&nbsp;</th>
                                                        <td valign="top">
                                                            <input name="action" type="submit" value="Submit" class="form-submit" />
                                                            <a href="AdminEventContentServlet?action=Search&EventID=<%=result.getTblEvents().getEventID()%>">   <input type="button" value="" class="form-reset"  /></a>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                </table>
