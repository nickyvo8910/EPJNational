    ...
    <body>
                        ...
                        <ul class="current"><li><a href="AdminEventShow.jsp"><b>Event</b><!--[if IE 7]><!--></a><!--<![endif]-->
                                ...
                                <div class="select_sub show">
                                    <ul class="sub">
                                        ...
                                        <li class="sub_show"><a href="AdminEventUploadImage.jsp">Image Upload</a></li>
                                    </ul>
                                </div>
                                <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                            </li>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Upload Image</h1></div>
                                    ...
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <div id="step-holder">
                                                ...
                                                <div class="step-dark-left"><a href="">Upload Event Image</a></div>
                                                <div class="step-dark-right">&nbsp;</div>
                                                <div class="clear"></div>
                                            </div>
                                            <!--  end step-holder -->
                                            <form action="upload_2.jsp" method="post" enctype="multipart/form-data">
                                                <!-- start id-form -->
